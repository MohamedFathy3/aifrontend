...
function RecordTable({ rows, type, selectedIds, onToggle, onConvert, onDelete, converting }: { rows: any[]; type: CrmType; selectedIds: number[]; onToggle: (id: number) => void; onConvert: (id: number) => void; onDelete: (id: number) => void; converting: boolean }) {
