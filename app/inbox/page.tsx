...
export default function InboxPage() {
  ...
  const deleteMessages = useMutation({ mutationFn: async () => apiClient.post("/v1/google/gmail/delete", { ids: selectedIds }), onSuccess: () => { setSelectedIds([]); setNotice("Selected emails deleted."); loadFirstPage(); } });
