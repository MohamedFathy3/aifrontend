...
export default function CalendarPage() {
  ...
  return <WorkspaceFrame title="Calendar" eyebrow="Appointments and client follow-up"><main className="standalone-page"><div className="content">
    <div className="page-intro"><div><p className="eyebrow">Sales calendar</p><h2>Plan the next conversation</h2><p>Choose a day to see its appointments and CRM tasks.</p></div><div className="top-actions"><span className="panel-count">{events.length + tasks.length} scheduled items</span><Link className="primary-button" href="/calendar/new">Add appointment</Link></div></div>
